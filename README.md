...
```
GET /api/invoices?from=01/05/2025&to=02/05/2025&page=1&limit=10&shift=morning&deleted=true
```
...
- `deleted`: `true` chỉ lấy hoá đơn đã xoá, `false` chỉ lấy hoá đơn chưa xoá, bỏ trống lấy tất cả
